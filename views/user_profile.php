...
?>
    ...
    <div id="contenido">
        ...
        <p class="texto"><a href="<?php echo $rootPath.'?controller='.$controller.'&amp;action=userPasswordEditForm&id='.$_SESSION[id].'&usuario='.$_SESSION[usuario].'';?>">Cambiar Contraseña</a></p>
